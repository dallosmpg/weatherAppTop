    ...
    const template = `
            ...
            <div class="curr-weather-temp-wind weather-card-data-group flex-center-column">
                ...
                <div class="curr-weather-temperature flex-center-column ">
                    <h3>Temperature: ${Number.parseFloat(filteredWeatherDataObj.currWeatherTemp).toFixed(1)} °C</h3>
                    <h2>Feels like: ${Number.parseFloat(filteredWeatherDataObj.currWeatherTempFL).toFixed(1)} °C</h2>
                </div>
            </div>
            <div class="curr-weather-wind flex-center-column weather-card-data-group">
                ...
                <h4>Speed: ${Number.parseFloat(filteredWeatherDataObj.currWeatherWindSpeed).toFixed(1)} m/s</h4>
            </div>
            <div class="curr-weather-misc flex-center-column weather-card-data-group">
                <h5>Cloud cover: ${filteredWeatherDataObj.currWeatherClouds}%</h5>
                <h5>Air pressure: ${filteredWeatherDataObj.currWeatherPress} hPa</h5>
                <h5>Rel. humidity: ${filteredWeatherDataObj.currWeatherHum}%</h5>
