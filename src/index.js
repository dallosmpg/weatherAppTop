...
async function populateCurrWeatherElems() {
  ...
  currentWeatherDiv.innerHTML =
    '<div style="grid-column: span 4;" class="spinner">';
...
async function populateForecastWeatherElems() {
  if (document.querySelector('.forecast-weather'))
    mainWeatherDisplay.removeChild(mainWeatherDisplay.lastElementChild);
